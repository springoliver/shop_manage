<x-storeowner-app-layout>
    ...
    <div class="py-4">
        <div class="mx-auto sm:px-6 lg:px-8">
            <!-- Supplier Name and Action Buttons -->
            <div class="mb-4 flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800">{{ $supplier->supplier_name }}</h2>
                </div>
                <div>
                            ...
                            @if(isset($storeProducts) && count($storeProducts) > 0)
                                @foreach($storeProducts as $product)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" title="{{ $product->product_notes ?? '-' }}">
